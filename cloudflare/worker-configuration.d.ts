/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare/worker-configuration.d.ts --env-interface CloudflareEnv` (hash: f41f27677cefcab7190df23377a32cd8)
// Runtime types generated with workerd@1.20260329.1 2026-03-31 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "AmplinkSession" | "AmplinkControlHub" | "AmplinkRelayRoom";
	}
	interface Env {
		AMPLINK_DESKTOPS: KVNamespace;
		AMPLINK_VOICE_PROFILES: KVNamespace;
		DB: D1Database;
		AI: Ai;
		...
		AMPLINK_CONTROL_BASE_URL: string;
		AMPLINK_DESKTOP_LISTENER_TOKEN: string;
		AMPLINK_BRIDGE_URL: string;
		CLOUDFLARE_API_TOKEN: string;
		AMPLINK_ADMIN_TOKEN: string;
		AMPLINK_CLOUDFLARE_ACCOUNT_ID: string;
		AMPLINK_CLOUDFLARE_WORKER_URL: string;
		AMPLINK_CLOUDFLARE_ADMIN_URL: string;
		AMPLINK_SESSION: DurableObjectNamespace<import("./worker").AmplinkSession>;
		AMPLINK_CONTROL: DurableObjectNamespace<import("./worker").AmplinkControlHub>;
		AMPLINK_RELAY_ROOM: DurableObjectNamespace<import("./worker").AmplinkRelayRoom>;
	}
}
