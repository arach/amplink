/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare/worker-configuration.d.ts --env-interface CloudflareEnv` (hash: a2e8aca33808d4f657582db0b5e486ca)
// Runtime types generated with workerd@1.20260329.1 2026-03-31 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "PlexusSession";
	}
	interface Env {
		PLEXUS_DESKTOPS: KVNamespace;
		DB: D1Database;
		AI: Ai;
		DESKTOP_DISPATCH_URL: "";
		ELEVENLABS_MODEL_ID: "eleven_multilingual_v2";
		ELEVENLABS_VOICE_ID: "REPLACE_WITH_ELEVENLABS_VOICE_ID";
		PLEXUS_DEFAULT_USER: "local-dev";
		PLEXUS_SESSION: DurableObjectNamespace<import("./worker").PlexusSession>;
	}
}
