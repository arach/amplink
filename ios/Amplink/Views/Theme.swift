// Theme — Shared design tokens for the Amplink iOS client.
//
...
struct AmplinkCardModifier: ViewModifier {
    var padding: CGFloat = AmplinkSpacing.md
    var cornerRadius: CGFloat = AmplinkRadius.md
...
extension View {
    func amplinkCard(padding: CGFloat = AmplinkSpacing.md,
                    cornerRadius: CGFloat = AmplinkRadius.md) -> some View {
        modifier(AmplinkCardModifier(padding: padding, cornerRadius: cornerRadius))
    }
}
...
struct StatusDot: View {
    ...
    var color: Color {
        switch status {
        case .active: AmplinkColors.statusActive
        case .connecting: AmplinkColors.statusStreaming
        case .idle: AmplinkColors.statusIdle
        case .error: AmplinkColors.statusError
        case .closed: AmplinkColors.statusIdle
        }
    }
...
struct PulseIndicator: View {
    ...
    var body: some View {
        Circle()
            .fill(AmplinkColors.accent.opacity(0.8))
