...
struct SpectatorView: View {
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                AmplinkColors.backgroundAdaptive.ignoresSafeArea()
                ...
                if let url = viewerURL {
                    ...
                    if isLoading {
                        ...
                        .background(AmplinkColors.backgroundAdaptive.opacity(0.9))
                    }
                } else {
                    VStack(spacing: AmplinkSpacing.lg) {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button { resumeSession() } label: {
                        ...
                        .foregroundStyle(canResume ? AmplinkColors.accent : AmplinkColors.textMuted)
                    }
                    .disabled(!canResume)
                }
            }
    ...
    private func resumeSession() {
        ...
        Task {
            do {
                ...
                isResuming = false
                AmplinkLog.session.error("Resume failed: \(error.localizedDescription)")
            }
        }
    }
}
...
struct BridgeWebView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        webView.underPageBackgroundColor = UIColor(AmplinkColors.backgroundAdaptive)
