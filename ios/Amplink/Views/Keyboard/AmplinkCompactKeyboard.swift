// AmplinkCompactKeyboard — UIKit QWERTY keyboard ported from Talkie's CompactKeyboardView.
//
...
// MARK: - AmplinkCompactKeyboard

final class AmplinkCompactKeyboard: UIView {

    // MARK: - Colors (dark-first, Amplink adapted)
    ...
    private func setupUI() {
        ...
        registerForTraitChanges([UITraitUserInterfaceStyle.self]) { (self: AmplinkCompactKeyboard, prev: UITraitCollection) in
...
/// SwiftUI wrapper for the UIKit-based AmplinkCompactKeyboard.
struct AmplinkCompactKeyboardView: UIViewRepresentable {
    var onInsert: (String) -> Void
    var onDelete: () -> Void
    var onReturn: () -> Void
    var onVoice: () -> Void

    func makeUIView(context: Context) -> AmplinkCompactKeyboard {
    ...
    func updateUIView(_ uiView: AmplinkCompactKeyboard, context: Context) {
