// KeyComponents — Individual key button views for AmplinkKeyboardView.
//
...
enum KeyStyle {
    ...
    case accent     // Voice, return — uses AmplinkColors.accent
...
struct CharKey: View {
    ...
    private var foregroundColor: Color {
        switch style {
        case .standard: .white
        case .special: AmplinkColors.textSecondary
        case .accent: .white
        case .delete: .white
        }
    }
    ...
    var body: some View {
        Button {
            ...
            Image(systemName: shiftIcon)
                ...
                .foregroundStyle(isShifted ? .white : AmplinkColors.textSecondary)
...
struct VoiceKey: View {
    ...
    private var buttonColor: Color {
        switch state {
        case .idle: AmplinkColors.accent
        case .recording: AmplinkColors.statusError
        case .processing: AmplinkColors.statusStreaming
        }
    }

    private var borderColor: Color {
        switch state {
        case .idle: AmplinkColors.accent.opacity(0.4)
        case .recording: AmplinkColors.statusError.opacity(0.4)
        case .processing: AmplinkColors.statusStreaming.opacity(0.4)
        }
    }
