                ...
                List {
                    ...
                    if !projects.isEmpty {
                        Section {
                            ...
                            Text("Projects")
                                .font(AmplinkTypography.caption(12, weight: .semibold))
    ...
    private var noWorkspaceView: some View {
        VStack(spacing: AmplinkSpacing.xl) {
            ...
            VStack(spacing: AmplinkSpacing.sm) {
                ...
                Text("Run `amplink init` on your computer to set up a workspace root.")
...
private struct ProjectRow: View {
    ...
    private var markerColor: Color {
        ...
        default:               return AmplinkColors.accent
        }
    }
}
