...
struct MicButton: View {
    ...
    private var buttonFillColor: Color {
        ...
        case .disabled:     AmplinkColors.textMuted.opacity(0.3)
        }
    }
    ...
    private var buttonBorderColor: Color {
        ...
        case .transcribing: AmplinkColors.statusStreaming.opacity(0.4)
        case .disabled:     AmplinkColors.textMuted.opacity(0.15)
        }
    }
    ...
    var body: some View {
        Button(action: action) {
            Image(systemName: icon)
                ...
                .foregroundColor(isActive ? AmplinkColors.textPrimary : AmplinkColors.textSecondary)
