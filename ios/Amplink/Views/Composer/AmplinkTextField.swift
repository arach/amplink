// AmplinkTextField — Editable text view that suppresses the native keyboard.
//
...
struct AmplinkTextField: UIViewRepresentable {
    ...
    private func updateColors(_ textView: UITextView) {
        textView.textColor = UIColor(AmplinkColors.textPrimary)
        textView.tintColor = UIColor(AmplinkColors.accent)
    }
    ...
    private func makePlaceholderLabel() -> UILabel {
        ...
        label.textColor = UIColor(AmplinkColors.textMuted)
    ...
    class Coordinator: NSObject, UITextViewDelegate {
        let parent: AmplinkTextField
        var placeholderLabel: UILabel?

        init(parent: AmplinkTextField) {
            self.parent = parent
        }
