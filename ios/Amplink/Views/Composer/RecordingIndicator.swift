...
struct RecordingIndicator: View {
    ...
    var body: some View {
        ...
        .overlay(
            RoundedRectangle(cornerRadius: AmplinkRadius.lg, style: .continuous)
    ...
    private var borderColor: Color {
        switch phase {
        case .recording: AmplinkColors.statusError.opacity(0.3)
        case .transcribing: AmplinkColors.statusStreaming.opacity(0.3)
        }
    }
...
private struct PulsingDot: View {
    ...
    var body: some View {
        Circle()
            ...
            .shadow(color: AmplinkColors.statusError.opacity(0.6), radius: pulsing ? 6 : 2)
        ...
        HStack(spacing: barSpacing) {
            ForEach(0..<barCount, id: \.self) { index in
                ...
                RoundedRectangle(cornerRadius: 1.5)
                    .fill(AmplinkColors.statusError.opacity(0.6 + Double(level) * 0.4))
                    .frame(
                        width: barWidth,
...
private struct WaveformBar: View {
    ...
    var body: some View {
        RoundedRectangle(cornerRadius: 1.5)
            .fill(AmplinkColors.statusError.opacity(0.7))
