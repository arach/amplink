// Identity — Keychain-based identity persistence for Amplink iOS.
//
...
final class AmplinkIdentity: Sendable {

    // Keychain service identifiers
    private static let service = "com.amplink.identity"
