// QRPayload — QR pairing payload model for Amplink iOS.
//
...
//     publicKey: "hex64",
//     expiresAt: unixMs,
//     cloudflareBaseUrl: "https://your-worker.your-subdomain.workers.dev"
//   }
...
struct QRPayload: Codable, Sendable {
    ...
    /// Matching Cloudflare voice backend for this paired bridge.
    let cloudflareBaseUrl: String?
}
...
extension QRPayload {
    ...
    func validate() -> String? {
        ...
        if let cloudflareBaseUrl, !cloudflareBaseUrl.isEmpty {
            guard let url = URL(string: cloudflareBaseUrl), url.scheme == "https" else {
                return "Invalid Cloudflare backend URL"
            }
        }
