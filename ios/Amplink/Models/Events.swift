...
struct SequencedEvent: Codable, Sendable {
    let seq: Int
    let event: AmplinkEvent
}

// MARK: - AmplinkEvent — discriminated union on "event" field

enum AmplinkEvent: Sendable {
...
extension AmplinkEvent: Codable {
