// SessionStore — Observable state container for Plexus sessions.
//
...
final class SessionStore: @unchecked Sendable {
    ...
    /// Route a single PlexusEvent to the appropriate handler.
    private func routeEvent(_ event: PlexusEvent) {
        switch event {
    ...
    private static func seqDefaultsKey(for bridgeKey: String) -> String {
        "plexus.lastAppliedSeq.\(bridgeKey)"
    }
